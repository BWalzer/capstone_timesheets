...
def request_page(page_number, header, customfield_id, last_updated):
    url = ('https://rest.tsheets.com/api/v1/customfielditems?active=both&page={}&customfield_id={}&modified_since={}T00:00:00%2B00:00'
            .format(page_number, customfield_id, last_updated))
